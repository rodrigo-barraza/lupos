...
const DungeonTimerService = {
  checkNextBFDReset() {
    ...
    if (now < initialBFDResetDate) {
      ...
      const periodsSinceInitialReset = Math.ceil(
        secondsSinceInitialReset / resetFrequencyInSeconds,
      );
      const nextResetDate =
        initialBFDResetDate +
        periodsSinceInitialReset * resetFrequencyInSeconds;
  ...
  daysUntilReset() {
    ...
    const daysUntilReset = moment(nextBFDResetDate)
      .startOf("day")
  ...
  async dungeonTimerMessage(interaction) {
    ...
    if (!daysUntilReset) {
      systemContent = `
            ...
            `;
      userContent =
        "Is it rad reset day today? I cannot wait to throw myself in a raid again. I am so excited!";
    } else if (hoursUntilReset < 24) {
      const nextResetDate =
        DungeonTimerService.getNextBFDResetDate().format("MMMM Do, YYYY");
      systemContent = `
            ...
            `;
      userContent =
        "In how many hours is the next raid reset? I am itching to get back in there and do some raids again. I am so excited!";
    } else {
      const nextResetDate =
        DungeonTimerService.getNextBFDResetDate().format("MMMM Do, YYYY");
      systemContent = `
            ...
            `;
      userContent =
        "When is the next raid reset date? I cannot wait to throw myself in a raid again. I am so excited!";
    }
    userContent =
      "When is the next raid reset date? I cannot wait to throw myself in a raid again. I am so excited!";

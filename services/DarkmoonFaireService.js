import { ActivityType as _ActivityType } from "discord.js";
...
const DarkmoonFaireService = {
  ...
  daysUntilFaire() {
    ...
    const daysUntilFaire = moment(nextFaire)
      .startOf("day")
  ...
  async darkmoonFaireMessage(interaction) {
    ...
    const getCurrentFaireFromToDates =
      DarkmoonFaireService.getCurrentFaireFromToDates();
    let systemContent = "";
    let userContent = "";
    if (isItCurrentFaireWeek) {
      ...
      systemContent = `
            ...
            `;
      userContent =
        "Can you explain when is the next Darkmoon Faire week, when does it go until, and how long does it last?";
    }

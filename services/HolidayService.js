...
const worldOfWarcraftHolidays = [
  {
    ...
    toDate: "November 1st",
    description:
      "Hallow's End is a celebration of the break between the Forsaken and the Scourge. Many tricks and treats await adventurers seeking holiday fun, including the Headless Horseman's haunted lair.",
  },
  {
    name: "Winter Veil",
  ...
  },
  {
    ...
    toDate: "February 7th",
    description:
      "The Lunar Festival is a time of celebration for the peoples of Azeroth. It is a time of remembrance for the fallen heroes of the past and a time of celebration for the heroes of the present.",
  },
  {
    ...
    description:
      "Love is in the Air is in the air in the major cities of Azeroth! New holiday attire, quests, and more are available.",
  },
  {
    name: "Noblegarden",
    fromDate: "April 5th",
  ...
  },
  {
    ...
    toDate: "May 10th",
    description:
      "The celebration of Children's Week begins in the capital cities of Azeroth and in Shattrath. It is a time for the heroes of the Horde and the Alliance to give back to the innocents of war-torn Azeroth.",
  },
  {
    ...
    toDate: "July 5th",
    description:
      "The Midsummer Fire Festival is a time of merriment and festivities, and the hottest season of the year.",
  },
  {
    name: "Pirate's Day",
    ...
    description:
      "Pirates have invaded the coasts of Azeroth and Northrend, and they are not leaving until they get what they want. The only way to get rid of them is to give them what they want.",
  },
  {
    name: "Brewfest",
    ...
    toDate: "October 6th",
    description:
      "Brewfest is a time to celebrate the harvest and to show appreciation for the fine beverages Azeroth has to offer!",
  },
  {
    ...
    toDate: "October 6th",
    description:
      "The Harvest Festival is a time to commemorate those who have sacrificed their lives to help friends and allies.",
  },
  {
    ...
    toDate: "November 3rd",
    description:
      "The Day of the Dead is a time to remember the fallen heroes of the Horde and Alliance.",
  },
  {
...
const HolidayService = {
  getNextHoliday() {
    ...
    const nextHoliday = sortedHolidays.find((holiday) =>
      holiday.fromDate.isAfter(currentDate),
    );
  ...
  getCurrentHoliday() {
    ...
    const currentHoliday = sortedHolidays.find(
      (holiday) =>
        holiday.fromDate.isBefore(currentDate) &&
        holiday.toDate.isAfter(currentDate),
    );

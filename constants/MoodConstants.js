/**
 * MoodConstants — Mood level definitions for MoodService.
 *
 * Each mood has a level (-10 to 10), name, emoji, and description
 * that influences the bot's personality in conversations.
 */
...
/**
 * Mood temperature → multiplier lookup table.
 * Replaces the 12-branch if/else chain in MoodService.generateMoodMessage().
 *
 * Each entry: [minTemp, maxTemp, direction, multiplier]
 * direction: "decrease" or "increase"
 */
export const MOOD_TEMPERATURE_THRESHOLDS = [
  [-10, -10, "decrease", 6],
  [-9, -8, "decrease", 5],
  [-7, -6, "decrease", 4],
  [-5, -4, "decrease", 3],
